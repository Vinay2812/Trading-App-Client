...
export const sendOtp = async (data: SendOtpRequest) => await api.post("/auth/send-otp", data);

export const validateOtp = async (data: ValidateOtpRequest) => await api.post("/auth/validate-otp", data);